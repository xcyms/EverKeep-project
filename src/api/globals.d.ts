...
declare global {
  interface Apis {
    ...
    lsky: {
      login<
        Config extends Alova2MethodConfig<Token> & {
          data: {
            email: string;
            password: string;
          };
      ...
      >(
        config: Config
      ): Alova2Method<Token, 'lsky.login', Config>;
      profile<Config extends Alova2MethodConfig<null> & {
        headers?: {
      ...
      logout<Config extends Alova2MethodConfig<null> & {
        ...
        config?: Config
      ): Alova2Method<null, 'lsky.logout', Config>;
      getImages<
        Config extends Alova2MethodConfig<Image[]> & {
          params: {
            page?: number;
